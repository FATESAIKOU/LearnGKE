...
| F4-2 | 執行 ESLint | 檢查程式碼風格 | ⬜ 未開始 |
| F4-3 | 測試詳情頁面 | 確認可正確顯示單一 Todo | ⬜ 未開始 |
...
| F5-4 | 執行 ESLint | 檢查程式碼風格 | ⬜ 未開始 |
| F5-5 | 測試新增功能 | 確認可成功新增 Todo | ⬜ 未開始 |
...
| F6-3 | 執行 ESLint | 檢查程式碼風格 | ⬜ 未開始 |
| F6-4 | 測試編輯功能 | 確認可成功更新 Todo | ⬜ 未開始 |
...
| F7-3 | 執行 ESLint | 檢查程式碼風格 | ⬜ 未開始 |
| F7-4 | 測試刪除功能 | 確認可成功刪除 Todo | ⬜ 未開始 |

### Phase 8: 完成狀態切換 (Toggle Complete)
| 步驟 | 項目 | 說明 | 狀態 |
|------|------|------|------|
| F8-1 | 實作 Checkbox | 在 TodoItem 加入完成狀態切換 | ⬜ 未開始 |
| F8-2 | 執行 ESLint | 檢查程式碼風格 | ⬜ 未開始 |
| F8-3 | 測試切換功能 | 確認可即時切換完成狀態 | ⬜ 未開始 |
